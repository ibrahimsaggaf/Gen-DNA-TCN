...
## Tutorial
To train Gen-DNA-TCN (**Model 1**) execute:
```
code
```

To train Gen-DNA-TCN (**Model 2**) execute:
```
code
```

To train Gen-DNA-TCN (**Model 3**) execute:
```
code
```

To generate synthetic sequences using real *n* starting nucleotides execute:
```
code
```

To generate synthetic sequences using random permutation execute:
```
code
```
to select synthetic sequences using bin-based sampling execute:
```
code
```
